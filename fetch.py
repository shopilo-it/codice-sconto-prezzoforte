#!/usr/bin/env python3
"""
Recupero codici sconto PrezzoForte da shopilo.it
Sursa: https://shopilo.it/negozi/prezzoforte.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/prezzoforte.it"
STORE_NAME = "PrezzoForte"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per PrezzoForte da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-prezzoforte)"
    }
    try:
